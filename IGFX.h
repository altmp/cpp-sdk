...
#define ALT_GFX_INVALID_HANDLE { alt::IGFX::kInvalidHandle }
...
/// Enable RGB write.
#define ALT_GFX_STATE_WRITE_RGB (0 \
	| ALT_GFX_STATE_WRITE_R \
	| ALT_GFX_STATE_WRITE_G \
	| ALT_GFX_STATE_WRITE_B \
	)

/// Write all channels mask.
#define ALT_GFX_STATE_WRITE_MASK (0 \
	| ALT_GFX_STATE_WRITE_RGB \
	| ALT_GFX_STATE_WRITE_A \
	| ALT_GFX_STATE_WRITE_Z \
	)
...
#define ALT_GFX_STATE_DEFAULT (0 \
	| ALT_GFX_STATE_WRITE_RGB \
	| ALT_GFX_STATE_WRITE_A \
	| ALT_GFX_STATE_WRITE_Z \
	| ALT_GFX_STATE_DEPTH_TEST_LESS \
	| ALT_GFX_STATE_CULL_CW \
	| ALT_GFX_STATE_MSAA \
	)
...
#define ALT_GFX_CLEAR_DISCARD_COLOR_MASK (0 \
	| ALT_GFX_CLEAR_DISCARD_COLOR_0 \
	| ALT_GFX_CLEAR_DISCARD_COLOR_1 \
	| ALT_GFX_CLEAR_DISCARD_COLOR_2 \
	| ALT_GFX_CLEAR_DISCARD_COLOR_3 \
	| ALT_GFX_CLEAR_DISCARD_COLOR_4 \
	| ALT_GFX_CLEAR_DISCARD_COLOR_5 \
	| ALT_GFX_CLEAR_DISCARD_COLOR_6 \
	| ALT_GFX_CLEAR_DISCARD_COLOR_7 \
	)

#define ALT_GFX_CLEAR_DISCARD_MASK (0 \
	| ALT_GFX_CLEAR_DISCARD_COLOR_MASK \
	| ALT_GFX_CLEAR_DISCARD_DEPTH \
	| ALT_GFX_CLEAR_DISCARD_STENCIL \
	)
...
#define ALT_GFX_BUFFER_COMPUTE_READ_WRITE (0 \
	| ALT_GFX_BUFFER_COMPUTE_READ \
	| ALT_GFX_BUFFER_COMPUTE_WRITE \
	)
...
#define ALT_GFX_SAMPLER_POINT (0 \
	| ALT_GFX_SAMPLER_MIN_POINT \
	| ALT_GFX_SAMPLER_MAG_POINT \
	| ALT_GFX_SAMPLER_MIP_POINT \
	)

#define ALT_GFX_SAMPLER_UVW_MIRROR (0 \
	| ALT_GFX_SAMPLER_U_MIRROR \
	| ALT_GFX_SAMPLER_V_MIRROR \
	| ALT_GFX_SAMPLER_W_MIRROR \
	)

#define ALT_GFX_SAMPLER_UVW_CLAMP (0 \
	| ALT_GFX_SAMPLER_U_CLAMP \
	| ALT_GFX_SAMPLER_V_CLAMP \
	| ALT_GFX_SAMPLER_W_CLAMP \
	)

#define ALT_GFX_SAMPLER_UVW_BORDER (0 \
	| ALT_GFX_SAMPLER_U_BORDER \
	| ALT_GFX_SAMPLER_V_BORDER \
	| ALT_GFX_SAMPLER_W_BORDER \
	)

#define ALT_GFX_SAMPLER_BITS_MASK (0 \
	| ALT_GFX_SAMPLER_U_MASK \
	| ALT_GFX_SAMPLER_V_MASK \
	| ALT_GFX_SAMPLER_W_MASK \
	| ALT_GFX_SAMPLER_MIN_MASK \
	| ALT_GFX_SAMPLER_MAG_MASK \
	| ALT_GFX_SAMPLER_MIP_MASK \
	| ALT_GFX_SAMPLER_COMPARE_MASK \
	)
...
#define ALT_GFX_CAPS_TEXTURE_COMPARE_ALL (0 \
	| ALT_GFX_CAPS_TEXTURE_COMPARE_RESERVED \
	| ALT_GFX_CAPS_TEXTURE_COMPARE_LEQUAL \
	)
...
#define ALT_GFX_STATE_BLEND_FUNC_SEPARATE(_srcRGB, _dstRGB, _srcA, _dstA) (UINT64_C(0) \
...
/// Additive blending.
#define ALT_GFX_STATE_BLEND_ADD (0                                         \
	| ALT_GFX_STATE_BLEND_FUNC(ALT_GFX_STATE_BLEND_ONE, ALT_GFX_STATE_BLEND_ONE) \
	)

/// Alpha blend.
#define ALT_GFX_STATE_BLEND_ALPHA (0                                                       \
	| ALT_GFX_STATE_BLEND_FUNC(ALT_GFX_STATE_BLEND_SRC_ALPHA, ALT_GFX_STATE_BLEND_INV_SRC_ALPHA) \
	)

/// Selects darker color of blend.
#define ALT_GFX_STATE_BLEND_DARKEN (0                                      \
	| ALT_GFX_STATE_BLEND_FUNC(ALT_GFX_STATE_BLEND_ONE, ALT_GFX_STATE_BLEND_ONE) \
	| ALT_GFX_STATE_BLEND_EQUATION(ALT_GFX_STATE_BLEND_EQUATION_MIN)          \
	)

/// Selects lighter color of blend.
#define ALT_GFX_STATE_BLEND_LIGHTEN (0                                     \
	| ALT_GFX_STATE_BLEND_FUNC(ALT_GFX_STATE_BLEND_ONE, ALT_GFX_STATE_BLEND_ONE) \
	| ALT_GFX_STATE_BLEND_EQUATION(ALT_GFX_STATE_BLEND_EQUATION_MAX)          \
	)

/// Multiplies colors.
#define ALT_GFX_STATE_BLEND_MULTIPLY (0                                           \
	| ALT_GFX_STATE_BLEND_FUNC(ALT_GFX_STATE_BLEND_DST_COLOR, ALT_GFX_STATE_BLEND_ZERO) \
	)

/// Opaque pixels will cover the pixels directly below them without any math or algorithm applied to them.
#define ALT_GFX_STATE_BLEND_NORMAL (0                                                \
	| ALT_GFX_STATE_BLEND_FUNC(ALT_GFX_STATE_BLEND_ONE, ALT_GFX_STATE_BLEND_INV_SRC_ALPHA) \
	)

/// Multiplies the inverse of the blend and base colors.
#define ALT_GFX_STATE_BLEND_SCREEN (0                                                \
	| ALT_GFX_STATE_BLEND_FUNC(ALT_GFX_STATE_BLEND_ONE, ALT_GFX_STATE_BLEND_INV_SRC_COLOR) \
	)

/// Decreases the brightness of the base color based on the value of the blend color.
#define ALT_GFX_STATE_BLEND_LINEAR_BURN (0                                                 \
	| ALT_GFX_STATE_BLEND_FUNC(ALT_GFX_STATE_BLEND_DST_COLOR, ALT_GFX_STATE_BLEND_INV_DST_COLOR) \
	| ALT_GFX_STATE_BLEND_EQUATION(ALT_GFX_STATE_BLEND_EQUATION_SUB)                          \
	)

///
#define ALT_GFX_STATE_BLEND_FUNC_RT_x(_src, _dst) (0         \
	| ( (uint32_t)( (_src)>>ALT_GFX_STATE_BLEND_SHIFT)       \
	| ( (uint32_t)( (_dst)>>ALT_GFX_STATE_BLEND_SHIFT)<<4) ) \
	)

///
#define ALT_GFX_STATE_BLEND_FUNC_RT_xE(_src, _dst, _equation) (0         \
	| ALT_GFX_STATE_BLEND_FUNC_RT_x(_src, _dst)                          \
	| ( (uint32_t)( (_equation)>>ALT_GFX_STATE_BLEND_EQUATION_SHIFT)<<8) \
	)
    ...
    public:
        ...
        struct Attachment
        {
            ...
            void init(
                ...
                , uint16_t _layer = 0
                , uint16_t _mip = 0
                , uint8_t _resolve = ALT_GFX_RESOLVE_AUTO_GEN_MIPS
                );
        ...
        struct Encoder
        {
            ...
            void setStencil(
                uint32_t _fstencil
                , uint32_t _bstencil = ALT_GFX_STENCIL_NONE
                );
            ...
            void setVertexBuffer(
                ...
                , VertexLayoutHandle _layoutHandle = ALT_GFX_INVALID_HANDLE
                );
            ...
            void submit(
                ...
                , uint32_t _depth = 0
                , uint8_t _flags  = ALT_GFX_DISCARD_ALL
                );
            ...
            ///
            ///
            void discard(uint8_t _flags = ALT_GFX_DISCARD_ALL);
        ...
        ///
        ///
        virtual uint32_t topologyConvert(
        ...
        ///
        ///
        virtual void topologySortTriList(
        ...
        ///
        ///
        virtual uint8_t getSupportedRenderers(
            uint8_t _max = 0
        ...
        virtual void reset(
            uint32_t _width
            , uint32_t _height
            , uint32_t _flags = ALT_GFX_RESET_NONE
            , TextureFormat::Enum _format = TextureFormat::Count
            ) = 0;
        ...
        ///
        ///
        virtual void dbgTextPrintfVargs(
            uint16_t _x
            , uint16_t _y
            , uint8_t _attr
            , const char* _format
        ...
        virtual IndexBufferHandle createIndexBuffer(
            const Memory* _mem
            , uint16_t _flags = ALT_GFX_BUFFER_NONE
            ) = 0;
        ...
        ///
        ///
        virtual DynamicIndexBufferHandle createDynamicIndexBuffer(
            uint32_t _num
            , uint16_t _flags = ALT_GFX_BUFFER_NONE
            ) = 0;
        ...
        ///
        ///
        virtual DynamicVertexBufferHandle createDynamicVertexBuffer(
            uint32_t _num
            , const VertexLayout& _layout
            , uint16_t _flags = ALT_GFX_BUFFER_NONE
            ) = 0;
        ...
        ///
        ///
        virtual uint32_t getAvailTransientVertexBuffer(
            uint32_t _num
            , const VertexLayout& _layout
            ) = 0;
        ...
        ///
        ///
        virtual uint32_t getAvailInstanceDataBuffer(
            uint32_t _num
            , uint16_t _stride
            ) = 0;
        ...
        ///
        ///
        virtual void allocTransientIndexBuffer(
        ...
        ///
        ///
        virtual void allocTransientVertexBuffer(
        ...
        ///
        ///
        virtual bool allocTransientBuffers(
            TransientVertexBuffer* _tvb
            , const VertexLayout& _layout
            , uint32_t _numVertices
            , TransientIndexBuffer* _tib
        ...
        ///
        ///
        virtual void allocInstanceDataBuffer(
        ...
        ///
        ///
        virtual uint16_t getShaderUniforms(
        ...
        virtual TextureHandle createTexture(
            const Memory* _mem
            , uint64_t _flags = ALT_GFX_TEXTURE_NONE|ALT_GFX_SAMPLER_NONE
            , uint8_t _skip = 0
        ...
        ///
        ///
        virtual TextureHandle createTexture3D(
            uint16_t _width
            , uint16_t _height
            , uint16_t _depth
            , bool _hasMips
        ...
        ///
        ///
        virtual void updateTextureCube(
            TextureHandle _handle
            , uint16_t _layer
            , uint8_t _side
            , uint8_t _mip
        ...
        virtual FrameBufferHandle createFrameBuffer(
            ...
            , uint16_t _height
            , TextureFormat::Enum _format
            , uint64_t _textureFlags = ALT_GFX_SAMPLER_U_CLAMP|ALT_GFX_SAMPLER_V_CLAMP
            ) = 0;
        ...
        ///
        ///
        virtual TextureHandle getTexture(
            FrameBufferHandle _handle
        ...
        ///
        ///
        virtual UniformHandle createUniform(
            const char* _name
        ...
        ///
        ///
        virtual OcclusionQueryResult::Enum getResult(
            OcclusionQueryHandle _handle
        ...
        ///
        ///
        virtual void setViewFrameBuffer(
            ViewId _id
            , FrameBufferHandle _handle
            ) = 0;
        ...
        /// @remarks
        ///   1. To setup more complex states use:
        virtual ///      `ALT_GFX_STATE_ALPHA_REF(_ref)`,
        virtual ///      `ALT_GFX_STATE_POINT_SIZE(_size)`,
        virtual ///      `ALT_GFX_STATE_BLEND_FUNC(_src, _dst)`,
        virtual ///      `ALT_GFX_STATE_BLEND_FUNC_SEPARATE(_srcRGB, _dstRGB, _srcA, _dstA)`
        virtual ///      `ALT_GFX_STATE_BLEND_EQUATION(_equation)`
        virtual ///      `ALT_GFX_STATE_BLEND_EQUATION_SEPARATE(_equationRGB, _equationA)`
        ///   2. `ALT_GFX_STATE_BLEND_EQUATION_ADD` is set when no other blend
        ///      equation is specified.
        ///
        ///
        ...
        /// @attention Pointer returned can be modifed until `IGFX::frame` is called.
        ///
        virtual uint32_t allocTransform(
            Transform* _transform
            , uint16_t _num
            ) = 0;
        ...
        ///
        ///
        virtual void setInstanceDataBuffer(
            const InstanceDataBuffer* _idb
            , uint32_t _start
            , uint32_t _num
            ) = 0;

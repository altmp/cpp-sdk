...
namespace alt
{
	...
	{
	public:
		CPlayerChangeAnimationEvent(const std::shared_ptr<IPlayer>& _target, uint32_t _oldAnimationDict, uint32_t _oldAnimationName, uint32_t _newAnimationDict, uint32_t _newAnimationName) :
